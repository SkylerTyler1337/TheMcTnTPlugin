...
public class TheMcTnTPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new ChunkGeneration(this), this);
        getServer().getPluginManager().registerEvents(new GameModeChangeEvent(), this);
        getServer().getPluginManager().registerEvents(new PlayerLogMessages(), this);
        getServer().getPluginManager().registerEvents(new MotdPing(this), this);
        getServer().getPluginManager().registerEvents(new CommandSethome(this), this);
        getServer().getPluginManager().registerEvents(new SnowFix(), this);
        getServer().getPluginManager().registerEvents(new InfiniteDispensor(this), this);
        getServer().getPluginManager().registerEvents(new ColorSigns(), this);
        ...
        getServer().getPluginManager().registerEvents(new AntiFallDamage(this), this);
